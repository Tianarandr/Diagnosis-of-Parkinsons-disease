...
def create_classifier(classifier_name, input_shape, nb_classes, output_directory, verbose=False):
    ...
    if classifier_name == 'mlp':
        ...
        return mlp.Classifier_MLP(output_directory, input_shape[0], nb_classes, verbose)
...
df_co = pd.read_csv('/Users/tahirintsoa/DATA_PARKINSON/Transformed_Data_ok/Ga/Transformed_Co.csv', index_col = 0)
df_pt = pd.read_csv('/Users/tahirintsoa/DATA_PARKINSON/Transformed_Data_ok/Ga/Transformed_Pt.csv' , index_col = 0)
...
if do_ensemble==False:
    ...
    if do_data_augmentation:
        ...
        aug_x_train = aug_x_train.reshape((aug_x_train.shape[0], aug_x_train.shape[1]))
